...
{
    public class ProductRepository : ImageRepository<Product>, IProductRepository
    {
        // Erro AQUI
        public ProductRepository(AppDbContext _DataBase, IWebService _WebService) : base(_DataBase, _WebService)
        {
        }
        ...
        //public async Task<Product> UpdateWithImageAsync (int Id, PatchRequestDTO requestDto)
        //{
